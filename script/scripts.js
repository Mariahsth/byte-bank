...
const graficoParaDolar = new Chart(graficoDolar, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [],
        borderWidth: 1,
        borderColor: 'rgb(75, 192, 147)',
        backgroundColor:'rgb(75, 192, 147)'
      }]
    },
  });
...
const graficoParaIene = new Chart(graficoIene, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [],
            borderWidth: 1,
            borderColor: 'rgb(131, 81, 247)',
            backgroundColor:'rgb(131, 81, 247)'
        }]
    }
})
...
const graficoParaEuro = new Chart(graficoEuro, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [],
            borderWidth: 1,
            borderColor: 'rgb(81, 139, 247)',
            backgroundColor:'rgb(81, 139, 247)'
        }]
    }
})
